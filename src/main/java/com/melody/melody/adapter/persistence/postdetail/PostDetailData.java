...
public class PostDetailData extends PostDetail {
    ...
    public PostDetailData(Long id, String title, String content, int likeCount, boolean open, boolean deleted, LocalDateTime createdDate,
                          Long userId, String nickname, Long musicId, Emotion emotion, String explanation, String imageUrl, String musicUrl) {
        super(id, title, content, likeCount, open, deleted, createdDate, userId, nickname, musicId, emotion, explanation, imageUrl, musicUrl);
    }
}
