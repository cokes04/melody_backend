...
class PostDaoTest {
    ...
    void setUp() {
        ...
        dao = new PostDao(entityManager, jpaRepository, jpaQueryFactory, mapper);
    }
    ...
    void findById_ShouldReturnPost_WhenExistPost() {
        ...
        Optional<Post> actual = dao.findById(postId);
